...
public class EditStudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        ArrayAdapter<ClassStanding> adapterTwo = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, ClassStanding.values());
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        standingSpinner.setAdapter(adapterTwo);
        ...
        if (getIntent().hasExtra(CourseDetailActivity.STUDENT_DATA)) {
            ...
            standingSpinner.setSelection(Student.findPositionStanding(student.getStanding().toString()));
            editing = true;
    ...
    public void onAddPressed(View view) {
        ...
        student.setStanding((ClassStanding) standingSpinner.getSelectedItem());
